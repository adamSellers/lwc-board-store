...
export default class BoardCard extends LightningElement {
  ...
  /** image url to use for the component, loaded from the static resource
   * boardImages. This will use the 200px image for the component.
   */
  boardImageUrl = boardImages + '/images/thumbs200/' + IMAGE_NAME_FIELD;
